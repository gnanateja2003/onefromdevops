...
<head>
  ...
  <title>NexusMobile — premium phone store</title>
  ...
  <style>
    /* ========== ROOT VARIABLES (phone-store vibe) ========== */
    :root {
      --bg: #f6f8fc;
      --bg-card: #ffffff;
      --primary: #0b1a33;
      --primary-light: #1f334f;
      --accent: #2563eb;
      --accent-light: #dbe7fe;
      --accent-dark: #1d4ed8;
      --muted: #5a6a7e;
      ...
      --radius: 18px;
      --radius-sm: 12px;
      --shadow: 0 6px 28px rgba(13, 37, 73, 0.06);
      --shadow-hover: 0 16px 48px rgba(13, 37, 73, 0.10);
    ...
    * {
    ...
    .btn-primary:hover {
      ...
      transform: translateY(-2px); box-shadow: 0 8px 24px rgba(37, 99, 235, 0.30);
    }
    .btn-secondary {
    ...
    header {
      ...
      border-bottom: 1px solid rgba(11,26,51,0.04);
    }
    .header-inner {
    ...
    #mobileMenu {
      ...
      border-top: 1px solid rgba(11,26,51,0.04);
      padding: 12px 0 20px;
    }
    #mobileMenu ul {
    ...
    .hero {
      ...
      min-height: 460px; padding: 50px 0;
      border-radius: var(--radius); overflow: hidden;
      margin: 18px 24px 0;
      background: linear-gradient(135deg, #0b1a33 0%, #1a3455 100%);
    }
    .hero::before {
      content: ''; position: absolute; inset: 0;
      background: url('https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=1400&q=80') center/cover no-repeat;
      opacity: 0.25; z-index: 0;
    }
    .hero .container { position: relative; z-index: 1; }
    .hero .badge {
      display: inline-block; background: rgba(37,99,235,0.20);
      color: #93bbff; padding: 4px 18px; border-radius: 999px;
    ...
    .deal-wrap .deal-img {
      flex: 0 0 48%; background: var(--surface); min-height: 280px;
    }
    ...
    .newsletter-wrap form input::placeholder { color: rgba(255,255,255,0.50); }
    ...
    /* ========== FOOTER ========== */
    footer { margin-top: 16px; padding: 44px 0 28px; border-top: 1px solid rgba(11,26,51,0.04); }
    .footer-grid {
    ...
    .footer-bottom {
      text-align: center; padding-top: 20px; border-top: 1px solid rgba(11,26,51,0.04);
...
<body>
    ...
    <div class="container header-inner">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <a class="brand" href="#">
          ...
          <span>Nexus<span class="accent">Mobile</span></span>
        </a>
      </div>
      ...
      <nav class="main-nav" id="mainNav" aria-label="Main navigation">
        <ul>
          ...
          <li><a href="#categories"><i class="fas fa-th-large"></i> Brands</a></li>
          <li><a href="#products"><i class="fas fa-fire"></i> Trending</a></li>
          <li><a href="#deals"><i class="fas fa-tag"></i> Flash</a></li>
      ...
      <div style="display:flex;align-items:center;gap:10px;">
        <div class="search-wrap" role="search">
          <input type="search" id="searchInput" placeholder="Search phones..." aria-label="Search" />
  ...
  <main>
    ...
    <!-- HERO (phone store vibe) -->
    <section class="hero" aria-label="Hero banner">
      <div class="container">
        <div class="badge"><i class="fas fa-sparkles"></i> New arrivals · 5G flagship</div>
        <h1>Find Your <br>Next Smartphone</h1>
        <p>Explore the latest iPhones, Galaxys, and Pixel — plus exclusive carrier deals.</p>
        <div class="actions">
          <button class="btn btn-primary" id="shopNow"><i class="fas fa-arrow-right"></i> Shop Phones</button>
          <button class="btn btn-ghost" id="exploreDeals"><i class="fas fa-clock"></i> Flash Deals</button>
        </div>
      </div>
    </section>

    <!-- CATEGORIES (phone brands) -->
    <section class="section" id="categories" aria-labelledby="cat-title">
      <div class="container">
        <div class="section-header">
          <div class="title-group">
            <h2 id="cat-title">Popular Brands</h2>
            <p>Shop by your favorite manufacturer</p>
          </div>
          <a href="#" class="view-all">All brands <i class="fas fa-arrow-right"></i></a>
        </div>
